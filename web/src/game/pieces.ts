...
// simClass presets: 1:{30,r1,f0.6} 2:static 3:{55,r0.5,f0.4} 4:ball
// 5:{30,nonconvex,r1,f0.6} 6:{10,r1,f0.6}
...
export const PIECES: Record<string, PieceDef> = {
  wallA: { kind: "box", size: [5, 25, 15], ...WALL, displayName: "Wall Thin", price: 100 },
  wallB: { kind: "box", size: [10, 25, 15], ...WALL, displayName: "Wall Thick", price: 500 },
  ...
  cannonA: { kind: "cannon", size: [16, 10, 10], ...HEAVY, displayName: "Cannon Small", price: 0 },
  cannonB: { kind: "cannon", size: [24, 15, 15], ...HEAVY, displayName: "Cannon Large", price: 2500 },
  flagPoleC: { kind: "flag", size: [1.2, 1.2, 20], ...LIGHT, displayName: "Flag", price: 5000 },
};
